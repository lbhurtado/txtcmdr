...
class SimulationSeeder extends Seeder
{
    ...
    {
        $area_nodes = [
            '5th District of Leyte.City of Baybay.Poblacion Zone 1.0001A',
            '5th District of Leyte.City of Baybay.Poblacion Zone 1.0001B',
            '5th District of Leyte.City of Baybay.Poblacion Zone 1.0002A',
            '5th District of Leyte.City of Baybay.Poblacion Zone 1.0002B',
            '5th District of Leyte.City of Baybay.Poblacion Zone 1.0003A',
            '5th District of Leyte.City of Baybay.Poblacion Zone 1.0003B',
            '5th District of Leyte.City of Baybay.Poblacion Zone 1.0004A',
            '5th District of Leyte.City of Baybay.Poblacion Zone 1.0005A',
            '5th District of Leyte.City of Baybay.Poblacion Zone 1.0006A',

            '5th District of Leyte.City of Baybay.Poblacion Zone 2.0007A',
            '5th District of Leyte.City of Baybay.Poblacion Zone 2.0008A',
...
//        $issue2 = Issue::create([ 'code' => 'BOYING', 'name' => 'Boying Cari']);
        ...
        foreach ($area_nodes as $area_node) {
            ...
            sleep(1);
            $precinct = Area::dig($area_node);
            $upline = factory(Contact::class)->create();
            $upline->syncAreas($precinct);
//            Issue::all()->each(function ($issue) use ($upline) {
//                $upline->issues()->attach($issue, ['qty'=>rand(100,500)]);
//
//            });

            $issues->each(function ($issue) use ($upline) {
                $upline->poll($issue->code, rand(100,500));
            });

            $contacts = factory(Contact::class, rand(1, 5))->create();
            foreach ($contacts as $contact){
                $upline->adopt($contact);
                $contact->syncAreas($precinct);
                ...
                tap($contact)->setStatus($status)->save();
